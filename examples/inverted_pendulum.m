...
[h, vel_limit]=inv_pend_constraints;
...
dlambda= 1e-10;              % initial value for dlambda for regularization
lambdaFactor = 1e-10;      % lambda scaling factor
...
opt_cost = J(end)
% plottings
inv_pend_plot(T,X,U,x0,xf,vel_limit,J)
% simulate with CBF
